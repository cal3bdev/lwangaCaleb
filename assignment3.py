"""
2026 FIFA World Cup Team Manager Simulation
Assignment 3

A text-based simulation that uses functions, loops, and randomness.
You manage a national team through three preparation days, a group
stage, and the knockout rounds. Your tactical choices change the team's
morale, injuries, and strength, which in turn affect match results.
"""
...
def simulate_match(team_strength, morale, injuries, opponent_rating, tactic_bonus=0):
    """Return 'win', 'draw', or 'loss' based on form, tactics, and luck."""
...
def pre_tournament_prep(morale, injuries, strength):
    """Run 3 preparation days; return updated morale, injuries, strength."""
...
def group_stage(morale, injuries, strength):
    """Play up to 3 group matches; return (qualified, morale, injuries, strength)."""
    print("\nGroup stage begins.")
    points = 0
    wins = 0
    losses = 0
...
def knockout_stage(morale, injuries, strength):
    """Play the knockout rounds until you are eliminated or win the final."""
